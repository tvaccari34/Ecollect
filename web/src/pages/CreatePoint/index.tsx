...
const CreatePoint = () => {
    ...
    const [ selectedCity, setSeletectCity ] = useState('0');
    ...
    function handleSeleteUf(event: ChangeEvent<HTMLSelectElement>) {
        const uf = event.target.value;

        setSelectedUf(uf);
    }

    function handleSeleteCity(event: ChangeEvent<HTMLSelectElement>) {
